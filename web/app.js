import { toDDL, toDiff, espresql_version }                             from '../dist/espresql.js';
import { state, LS_ERD_POS, LS_ERD_COL }                          from './state.js';
import { highlightEspreSQL, highlightSQL }                          from './highlight.js';
...
function makeFooter(input) {
    ...
    return `\n-- Generated by Radicle EspreSQL ${espresql_version()} ${new Date().toLocaleString()}\n\n/*\n${safe}\n\n*/`;
}
...
function update() {
    ...
    qsHl.innerHTML   = highlightEspreSQL(src) + '\n ';
    updateCurLine();
