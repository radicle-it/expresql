...
var t = /* @__PURE__ */ new Set([
	...
	emitNode(e, t, n) {
		...
		let l = this.prefix ? a.name.replace(RegExp(`^${d(this.prefix)}_`, "i"), "") : a.name, u = [...s, ...this.emitTableMetaDirectivesList(a)], f = `${r}${l}`;
		a.note && (f += ` [${a.note}]`), u.length && (f += " " + u.join(" ")), i.push(f);
		for (let e of o) {
